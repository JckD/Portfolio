                    ...
                    <Row md={1}>
                      ...
                      <Col sm={true} md={true} lg={true}>
                        <div id="aboutMeDiv" className="contentCard" >
                          <h3>Education</h3>
                          <p>
                            I am a recent graduate from BSc Computer Science (Infrastructure)
                            ...
                            I really enjoyed the opportunity to get an outlook in different technologies and learn about them in a sctructured way.
                          </p>
                          <p>
                            I attended Christian Brothers College in Monkstown for Secondary level and Leaving Cert.
                          </p>
                          <hr />
                          <h3>Skills</h3>
                          <p>
                          ...
                          <p>
                            ...
                            I put a lot of work into organising events with the committee there that required commuinication
